...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        # Create an alien adn keep adding aliens until there is no room left.
        # Spacing between aliens is one alien width and one aliens height.
        # Make an alien.
        alien = Alien(self)
        ...
        while current_y < (self.settings.screen_height - 3 * alien_height):
            ...
            # Finish a row; reset x and increment y
